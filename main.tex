...
\def\ps@bimapfirst{%
  ...
  \def\@oddhead{{\small\sc Final report of the BIMAP project, submitted to the AnKi Lab}\hfill {\small\rm \today}}%
  \def\@evenhead{}%
...
end-to-end pipeline that segments neuronal somata in calcium-imaging recordings using a
