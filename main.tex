...
Strong automated tools for this step already exist: classical toolboxes that rely on hand-tuned
assumptions about the activity signal, and deep-learning segmenters that perform well but are trained
on hand-annotated data \citep{pachitariu2017suite2p,giovannucci2019caiman,stringer2021cellpose}. My
starting point is not that segmentation is unsolved, but that the best methods share one limiting
resource: labeled calcium-imaging data is scarce and expensive to produce, so segmentation still
leans on slow, subjective manual annotation whenever those labels are missing. Unlabeled calcium
video, by contrast, is abundant: any recording session produces it for free.
