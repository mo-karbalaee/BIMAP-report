...
The complete per-run, per-epoch experimental log (training and validation curves and the final
held-out scores for every run) is included with the code at
\url{https://github.com/mo-karbalaee/NEUROSEG}. Table~\ref{tab:hparams} lists the training settings
shared across experiments; the final scores are reported in Section~\ref{sec:results}.
